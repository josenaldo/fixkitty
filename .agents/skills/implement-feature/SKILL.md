...
description: "Meta-skill para implementar uma feature ponta a ponta sem acoplar camadas. Use quando a tarefa exigir atravessar domain, application, infrastructure, interfaces e testes em sequência controlada."
---
...
Use [../layer-domain/SKILL.md](../layer-domain/SKILL.md) para:
...
Use [../layer-application/SKILL.md](../layer-application/SKILL.md) para:
- criar/alterar use cases
- definir fluxo, sequência e política de falha

### 3. Implementar adapters em infrastructure

Use [../layer-infrastructure/SKILL.md](../layer-infrastructure/SKILL.md) para:
- implementar ports
...
Use [../layer-interface/SKILL.md](../layer-interface/SKILL.md) para:
- conectar GUI, TUI ou bootstrap
- apresentar resultado sem duplicar regra

### 5. Cobrir com testes

Use [../write-tests/SKILL.md](../write-tests/SKILL.md) para:
- validar domain
- cobrir use cases
...
Use [../enforce-architecture/SKILL.md](../enforce-architecture/SKILL.md) por último.
...
Tarefa: adicionar uma nova capacidade de recuperação.
...
6. Rodar a revisão de arquitetura
